...
function Myticket() {
  ...
  async function getdata(id) {
    try {
      let res = await axios.post(
        `${process.env.REACT_APP_SERVER_URL}/order/myticket`,
        {
          id,
        }
      );
  ...
  async function getdataToday() {
    ...
    try {
      let res = await axios.post(
        `${process.env.REACT_APP_SERVER_URL}/order/myticket/today`,
        {
          id,
        }
      );
  ...
  async function getdataUpcoming() {
    ...
    try {
      let res = await axios.post(
        `${process.env.REACT_APP_SERVER_URL}/order/myticket/upcoming`,
        {
          id,
        }
      );
  ...
  async function getdataPast() {
    ...
    try {
      let res = await axios.post(
        `${process.env.REACT_APP_SERVER_URL}/order/myticket/past`,
        {
          id,
        }
      );
  ...
  async function handledelete(ele) {
    ...
    try {
      let res = await axios.delete(
        `${process.env.REACT_APP_SERVER_URL}/order/oneorder/:${userid}`
      );
      getdata(userid1);
