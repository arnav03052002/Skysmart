...
function Slider() {
  ...
  const handleGetRequest = async () => {
    try {
      let res = await axios.post("https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/city", {
        source,
      });
      res = res.data;
      setOutput(res);
  ...
  async function getcityinfo(source, destination, date) {
    try {
      let res = await axios.post("https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/city/showcity", {
        source,
        destination,
        date,
      });
      ...
      <div className={styles.Carousel}>
        ...
        <div className={styles.infodiv}>
          ...
          <div>
            ...
            <p>
              A unique certification program that ensures safety in all aeroplanes
            </p>
          </div>
          <div>
            <div>
