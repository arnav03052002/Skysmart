...
function Myticket() {
  ...
  async function getdata(id) {
    try {
      let res = await axios.post("https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/order/myticket", {
        id,
      });
      // console.log(res);
      setdata(res.data);
  ...
  async function getdataToday() {
    ...
    try {
      let res = await axios.post("https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/order/myticket/today", {
        id,
      });
  ...
  async function getdataUpcoming() {
    ...
    try {
      let res = await axios.post(
        "https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/order/myticket/upcoming",
        {
          id,
        }
      );
  ...
  async function getdataPast() {
    let id = Cookies.get("userid");
    try {
      let res = await axios.post("https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/order/myticket/past", {
        id,
      });
  ...
  async function handledelete(ele) {
    ...
    try {
      let res = await axios.delete(
        `https://ed66-2603-8000-57f0-9250-849e-941-d5df-88bd.ngrok-free.app/order/oneorder/:${userid}`
      );
      getdata(userid1);
